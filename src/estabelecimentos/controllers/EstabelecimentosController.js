 ...
 // Renderiza a tabela de estabelecimentos
    index = async (req, res) => {
        ...
        try {
            ...
            console.error('Erro ao obter todos od estabelecimentos.', error);
            res.status(500).json({ message: 'Erro ao obter todos od estabelecimentos.' });
        }
    }



	// Método para renderizar o formulario de cadastro de estabelecimentos
