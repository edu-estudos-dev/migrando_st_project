...
class EstabelecimentosController {
        ...
        try {
            ...
            const estabelecimento = {
                ...
                produto: Array.isArray(produtos)
                    ? produtos.map(p => (p ? p.trim().toUpperCase() : '')).join(', ')
                    : produtos
    ...
    async editEstabelecimento(req, res) {
        ...
        try {
            ...
            // Comparar os dados enviados com os dados atuais
            ...
            // Executar a atualização apenas se houver mudanças
    ...
    async viewEstabelecimento(req, res) {
        ...
        try {
            ...
            console.error('Erro ao buscar dados do estabelecimento para visualização.', error);
            res
                .status(500)
                .json({ message: 'Erro ao buscar dados do estabelecimento.' });
        }
    ...
    async excluirEstabelecimento(req, res) {
        ...
        try {
            ...
            return res.status(500).json({ message: 'Erro ao excluir estabelecimento', error: error.message });
        }
    }
}
